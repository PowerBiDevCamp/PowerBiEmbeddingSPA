...
export default class SpaAuthService {
    ...
    private static scopesPowerBi : string[] = [
    ...
    static login = async () => {
        var loginRequest : msal.AuthorizationUrlRequest = { scopes: SpaAuthService.scopesPowerBi }
    ...
    static async getAccessToken(): Promise<string> {
        ...
        var tokenRequest: msal.SilentRequest = {
            scopes: SpaAuthService.scopesPowerBi,
